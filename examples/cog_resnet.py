...
from rlkit.torch.conv_networks import Pretrained, ConcatPre
...
def experiment(variant, comet_logger):
    ...
    qf1 = ConcatPre(**cnn_params)
    qf2 = ConcatPre(**cnn_params)
    target_qf1 = ConcatPre(**cnn_params)
    target_qf2 = ConcatPre(**cnn_params)
    ...
    policy_obs_processor = ConcatPre(**cnn_params)
...
if __name__ == "__main__":
    ...
    comet_exp = comet_ml.Experiment(
        api_key='',
        project_name='cogproject',
        workspace=""
    )
    logger = Log(PATH='/Users/parnika./Documents/cog/logs')
    comet_exp.add_tag("project")
    comet_exp.set_name("cog_td3_resnet18")
    ...
    variant = dict(
        ...
        trainer_kwargs=dict(
            ...
            policy_eval_start=10000, # 10k bc steps
            num_qs=2,
    ...
    parser.add_argument("--alg_name", type=str, default='TD3_BC') # [TD3_BC, CQL]
    ...
    variant['alg_name']= args.alg_name
